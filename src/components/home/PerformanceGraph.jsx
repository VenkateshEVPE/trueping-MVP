...
const PerformanceGraph = ({ insets }) => {
  ...
  // Sample data points for the line graph (creating undulating wave from high to low)
  // These represent latency values over time
  const dataPoints = [
    { x: 0, y: 0.1 },      // Start high (near top)
    { x: 0.15, y: 0.25 },  // Slight dip
    { x: 0.3, y: 0.15 },   // Peak
    { x: 0.45, y: 0.4 },   // Valley
    { x: 0.6, y: 0.3 },    // Peak
    { x: 0.75, y: 0.6 },   // Valley
    { x: 0.9, y: 0.5 },    // Mid
    { x: 1.0, y: 0.65 },   // End point low (near bottom, where marker is)
  ]
